...
<div class="row">
    ...
    <div class="col-lg-2">
        <a href="{{ route('klasifikasi_surat.create') }}" class="btn btn-primary btn-rounded btn-fw"><i
                class="fa fa-plus"></i>
            Add Klasifikasi Surat</a>
    </div>
                    ...
                    <table class="table table-striped" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="py-1">
                                    <a href="{{route('klasifikasi_surat.show', $klasifikasi_surats->id)}}">
                                    ...
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start"
                                            ...
                                            <a class="dropdown-item"
                                                href="{{route('klasifikasi_surat.edit', $klasifikasi_surats->id)}}"> Edit </a>
                                            <form action="{{ route('klasifikasi_surat.destroy', $klasifikasi_surats->id) }}"
