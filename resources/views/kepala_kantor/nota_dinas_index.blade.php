...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <a href="{{ route('nota_dinas_kepala_kantor.create') }}" class="btn btn-primary btn-rounded btn-fw"><i
                    class="fa fa-plus"></i>
                Add Nota Dinas</a>
        </div>
        <div class="col-lg-12">
                            ...
                            <tbody>
                                @foreach ($nota_dinas as $nota_dinass)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('nota_dinas_kepala_kantor.show', $nota_dinass->id) }}">
                                            ...
                                            <div class="btn-group dropdown">
                                                ...
                                                <div class="dropdown-menu" x-placement="bottom-start"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('nota_dinas_kepala_kantor.edit', $nota_dinass->id) }}">
                                                        Edit
                                                    </a>
                                                    <form
                                                        action="{{ route('nota_dinas_kepala_kantor.destroy', $nota_dinass->id) }}"
