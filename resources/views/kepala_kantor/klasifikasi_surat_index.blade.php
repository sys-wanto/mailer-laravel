                    ...
                    <table class="table table-striped" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="py-1">
                                    <a href="{{route('klasifikasi_surat_kepala_kantor.show', $klasifikasi_surats->id)}}">
                                    ...
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start"
                                            ...
                                            <a class="dropdown-item"
                                                href="{{route('klasifikasi_surat_kepala_kantor.edit', $klasifikasi_surats->id)}}"> Edit </a>
                                            <form action="{{ route('klasifikasi_surat_kepala_kantor.destroy', $klasifikasi_surats->id) }}"
