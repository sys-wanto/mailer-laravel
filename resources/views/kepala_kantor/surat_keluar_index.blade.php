...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <a href="{{ route('surat_keluar_kepala_kantor.create') }}" class="btn btn-primary btn-rounded btn-fw"><i
                    class="fa fa-plus"></i>
                Add Surat Keluar</a>
        </div>
        <div class="col-lg-12">
                            ...
                            <tbody>
                                @foreach ($surat_keluar as $surat_keluars)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('surat_keluar_kepala_kantor.show', $surat_keluars->id) }}">
                                            ...
                                            <div class="btn-group dropdown">
                                                ...
                                                <div class="dropdown-menu" x-placement="bottom-start"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('surat_keluar_kepala_kantor.edit', $surat_keluars->id) }}">
                                                        Edit
                                                    </a>
                                                    <form
                                                        action="{{ route('surat_keluar_kepala_kantor.destroy', $surat_keluars->id) }}"
