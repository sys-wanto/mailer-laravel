...
<form action="{{ route('disposisi_kepala_kantor.update', $disposisi->id) }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    {{ method_field('put') }}
    <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{route('kepala_kantor.disposisi_index')}}" class="btn btn-light pull-right">Back</a>
                        </div>
                    </div>
                </div>
            </div>
