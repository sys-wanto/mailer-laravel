...
@section('content')
    ...
    <form method="POST" action="{{ route('surat_keluar_staff_seksi.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group{{ $errors->has('tujuan_surat_keluar') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="tujuan_surat_keluar" type="text" class="form-control"
                                            name="tujuan_surat_keluar" placeholder="Enter Lampiran Surat Keluar"
                                ...
                                <div class="form-group">
                                    <label for="file_surat_keluar" class="col-md-4 col-form-label-text-md-right">File
                                        Surat
                                        Keluar</label>
                                    <div class="col-md-6">
                                ...
                                <a href="{{ route('surat_keluar_staff_seksi.index') }}"
