...
@section('content')
    ...
    <form method="POST" action="{{ route('surat_tugas_staff_seksi.store') }}" enctype="multipart/form-data">
        {{ csrf_field() }}
        <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group{{ $errors->has('tempat_tugas') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="tempat_tugas" type="text" class="form-control" name="tempat_tugas"
                                            placeholder="Enter Tempat Tugas" value="{{ old('tempat_tugas') }}"
                                            required>
                                ...
                                <a href="{{ route('surat_tugas_staff_seksi.index') }}"
