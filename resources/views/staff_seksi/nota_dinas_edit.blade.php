...
<form action="{{ route('nota_dinas_staff_seksi.update', $nota_dinas->id) }}" method="post" enctype="multipart/form-data">
    {{ csrf_field() }}
    {{ method_field('put') }}
    <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{route('nota_dinas_staff_seksi.index')}}" class="btn btn-light pull-right">Back</a>
                        </div>
                    </div>
                </div>
            </div>
