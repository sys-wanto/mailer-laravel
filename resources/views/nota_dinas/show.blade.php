                    ...
                    <div class="card-body">
                        ...
                        <form class="forms-sample">
                            <div class="form-group{{ $errors->has('nama_seksi') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="nama_seksi" type="text" class="form-control" name="nama_seksi"
                                        value="{{ $nota_dinas->seksi->kode_seksi }} | {{ $nota_dinas->seksi->nama_seksi }}" readonly="">
                            ...
                            <div class="form-group{{ $errors->has('nama_klasifikasi') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="nama_klasifikasi" type="text" class="form-control" name="nama_klasifikasi"
                                        value="{{ $nota_dinas->klasifikasi_surat->kode_klasifikasi }} | {{ $nota_dinas->klasifikasi_surat->nama_klasifikasi }}" readonly="">
                            ...
                            <div class="form-group{{ $errors->has('file_nota_dinas') ? ' has-error' : '' }}">
                                <label for="file_nota_dinas" class="col-md-4 control-label">File
                                    Nota Dinas</label>
                                <div class="col-md-6">
                            ...
                            <a href="{{route('nota_dinas.index')}}" class="btn btn-light pull-right">Back</a>
                    </div>
                </div>
            </div>
        </div>
