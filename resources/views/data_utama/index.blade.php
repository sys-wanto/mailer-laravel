...
<div class="row">
    ...
    <div class="col-lg-2">
        <a href="{{ route('data_utama.create') }}" class="btn btn-primary btn-rounded btn-fw"><i class="fa fa-plus"></i>
          Add Data Utama</a>
    </div>
...
<div class="row" style="margin-top: 20px;">
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                <h4 class="card-title pull-left">Data Utama</h4>
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="py-1">
                                    <a href="{{route('data_utama.show', $data_utamas->id)}}">
                                ...
                                <td>
                                    <div class="btn-group dropdown">
                                        ...
                                        <div class="dropdown-menu" x-placement="bottom-start"
                                            ...
                                            <a class="dropdown-item" href="{{route('data_utama.edit', $data_utamas->id)}}"> Edit </a>
                                            <form action="{{ route('data_utama.destroy', $data_utamas->id) }}" class="pull-left"
                                                method="post">
                                                {{ csrf_field() }}
                                                {{ method_field('delete') }}
