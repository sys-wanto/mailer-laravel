    ...
    <div class="col-md-12 d-flex align-items-stretch grid-margin">
        <div class="row flex-grow">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Detail Data - <b>{{$jenis_datas->data_utama->nama_data}}</b> </h4>
                        <form class="forms-sample">
                            <div class="form-group{{ $errors->has('nama_data') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="nama_data" type="text" class="form-control" name="nama_data"
                                        value="{{ $jenis_datas->data_utama->nama_data }}" readonly="">
                            ...
                            <div class="form-group{{ $errors->has('nama_jenis_data') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <input id="nama_jenis_data" type="text" class="form-control" name="nama_jenis_data"
                                        value="{{ $jenis_datas->nama_jenis_data }}" readonly="">
                            ...
                            <div class="form-group{{ $errors->has('nama_kategori_data') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <ul>
                                        @foreach ($jenis_datas->kategori_datas as $value )
