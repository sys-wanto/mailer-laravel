                                ...
                                <div class="form-group{{ $errors->has('kode_seksi') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="kode_seksi" type="text" class="form-control" name="kode_seksi"
                                            value="{{ $surat_keluar->seksi->kode_seksi }} | {{ $surat_keluar->seksi->nama_seksi }}"
                                            readonly="">
                                ...
                                <div class="form-group{{ $errors->has('nama_klasifikasi') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nama_klasifikasi" type="text" class="form-control"
                                            ...
                                            value="{{ $surat_keluar->klasifikasi_surat->kode_klasifikasi }} | {{ $surat_keluar->klasifikasi_surat->nama_klasifikasi }}"
                                            readonly="">
                                ...
                                <div class="form-group{{ $errors->has('nomor_surat') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6">
                                        <input id="nomor_surat" type="text" class="form-control" name="nomor_surat"
                                            value="{{ $surat_keluar->nomor_surat }}" readonly>
