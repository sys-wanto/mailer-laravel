...
@section('content')
                                ...
                                <div class="bs-stepper-header" role="tablist">
                                    ...
                                    <div id="steptrack4" class="step" data-target="#tindak-lanjut">
                                        <button type="button" class="step-trigger" role="tab"
                                            ...
                                            <span class="bs-stepper-label">Diterima oleh Staff Seksi & akan di tindak lanjut</span>
                                        </button>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="row">
        <div class="col-lg-2">
            <a href="{{ route('surat_masuk.create') }}" class="btn btn-primary btn-rounded btn-fw"><i
                    class="fa fa-plus"></i>
                Add Surat Masuk</a>
        </div>
        <div class="col-lg-12">
                            ...
                            <tbody>
                                @foreach ($surat_masuk as $surat_masuks)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('surat_masuk.show', $surat_masuks->id) }}">
                                            ...
                                            <div class="btn-group dropdown">
                                                ...
                                                <div class="dropdown-menu" x-placement="bottom-start"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('surat_masuk.edit', $surat_masuks->id) }}">
                                                        Edit
                                                    </a>
                                                    <form action="{{ route('surat_masuk.destroy', $surat_masuks->id) }}"
