...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <a href="{{ route('surat_tugas.create') }}" class="btn btn-primary btn-rounded btn-fw"><i
                    class="fa fa-plus"></i>
                Add Surat Tugas</a>
        </div>
        <div class="col-lg-12">
                            ...
                            <tbody>
                                @foreach ($surat_tugas as $surat_tugass)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('surat_tugas.show', $surat_tugass->id) }}">
                                            ...
                                            <div class="btn-group dropdown">
                                                ...
                                                <div class="dropdown-menu" x-placement="bottom-start"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('surat_tugas.edit', $surat_tugass->id) }}">
                                                        Edit
                                                    </a>
                                                    <form action="{{ route('surat_tugas.destroy', $surat_tugass->id) }}"
