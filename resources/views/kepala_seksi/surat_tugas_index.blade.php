                            ...
                            <tbody>
                                @foreach ($surat_tugas as $surat_tugass)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('surat_tugas_kepala_seksi.show', $surat_tugass->id) }}">
                                            ...
                                            <div class="btn-group dropdown">
                                                ...
                                                <div class="dropdown-menu" x-placement="bottom-start"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ route('surat_tugas_kepala_seksi.edit', $surat_tugass->id) }}">
                                                        Edit
                                                    </a>
                                                    <form
                                                        action="{{ route('surat_tugas_kepala_seksi.destroy', $surat_tugass->id) }}"
