...
<form method="POST" action="{{ route('surat_keluar_kepala_seksi.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="{{route('surat_keluar_kepala_seksi.index')}}" class="btn btn-light pull-right">Back</a>
                        </div>
                    </div>
                </div>
            </div>
