...
class SuratKeluar_KepalaKantorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kepala_kantor.surat_keluar_index', compact('surat_keluar'));
    }
    ...
    public function create()
    {
        ...
        return view('kepala_kantor.surat_keluar_create', compact('seksi', 'klasifikasi_surat'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kepala_kantor.surat_keluar_index');
    ...
    public function show($id)
    {
        ...
        return view('kepala_kantor.surat_keluar_show', compact('surat_keluar'));
    }
    ...
    {   
        ...
        return view('kepala_kantor.surat_keluar_edit', compact('surat_keluar', 'seksi', 'klasifikasi_surat'));
    }
