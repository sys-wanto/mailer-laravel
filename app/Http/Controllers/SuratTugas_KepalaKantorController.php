...
class SuratTugas_KepalaKantorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kepala_kantor.surat_tugas_index', compact('surat_tugas'));
    }
    ...
    public function create()
    {
        ...
        return view('kepala_kantor.surat_tugas_create', compact('seksi', 'pegawai', 'klasifikasi_surat'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kepala_kantor.surat_tugas_index');
    ...
    public function show($id)
    {
        ...
        return view('kepala_kantor.surat_tugas_show', compact('surat_tugas'));
    }
    ...
    {   
        ...
        return view('kepala_kantor.surat_tugas_edit', compact('surat_tugas', 'seksi', 'pegawai', 'klasifikasi_surat'));
    }
