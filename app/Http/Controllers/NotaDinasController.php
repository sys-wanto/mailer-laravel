...
class NotaDinasController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('nota_dinas.index', compact('nota_dinas'));
    }
    ...
    public function create()
    {
        ...
        return view('nota_dinas.create', compact('seksi', 'klasifikasi_surat'));
    }
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('nota_dinas.index');
        } catch (\Throwable $err) {
    ...
    public function show($id)
    {
        ...
        return view('nota_dinas.show', compact('nota_dinas'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('nota_dinas.edit', compact('nota_dinas', 'seksi', 'klasifikasi_surat'));
    }
