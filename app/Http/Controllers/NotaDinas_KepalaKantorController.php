...
class NotaDinas_KepalaKantorController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kepala_kantor.nota_dinas_index', compact('nota_dinas'));
    }
    ...
    public function create()
    {
        ...
        return view('kepala_kantor.nota_dinas_create', compact('seksi', 'klasifikasi_surat'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kepala_kantor.nota_dinas_index');
    ...
    public function show($id)
    {
        ...
        return view('kepala_kantor.nota_dinas_show', compact('nota_dinas'));
    }
    ...
    {   
        ...
        return view('kepala_kantor.nota_dinas_edit', compact('nota_dinas', 'seksi', 'klasifikasi_surat'));
    }
