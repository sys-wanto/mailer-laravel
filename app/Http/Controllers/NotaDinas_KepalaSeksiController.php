...
class NotaDinas_KepalaSeksiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kepala_seksi.nota_dinas_index', compact('nota_dinas'));
    }
    ...
    public function create()
    {
        ...
        return view('kepala_seksi.nota_dinas_create', compact('seksi', 'klasifikasi_surat'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('kepala_seksi.nota_dinas_index');
    ...
    {   
        ...
        return view('kepala_seksi.nota_dinas_edit', compact('nota_dinas', 'seksi', 'klasifikasi_surat'));
    }
