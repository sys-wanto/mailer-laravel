...
class SuratKeluar_StaffSeksiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('staff_seksi.surat_keluar_index', compact('surat_keluar'));
    }
    ...
    public function create()
    {
        ...
        return view('staff_seksi.surat_keluar_create', compact('seksi', 'klasifikasi_surat'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('surat_keluar_staff_seksi.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('staff_seksi.surat_keluar_show', compact('surat_keluar'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('staff_seksi.surat_keluar_edit', compact('surat_keluar', 'seksi', 'klasifikasi_surat'));
    }
